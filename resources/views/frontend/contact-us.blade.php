                ...
                <form class="space-y-6" method="POST" action="{{ url('contact') }}">
                    ...
                    <div>
                        ...
                        <input type="text" name="name"
                            class="w-full px-4 py-3 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary-300 transition-all duration-300"
                    ...
                    <button type="submit"
                        class="w-full bg-primary-500 text-white py-3 rounded-lg font-semibold hover:bg-primary-600 transition-all duration-300 shadow-md flex items-center justify-center">
            ...
            <div class="space-y-8">
                ...
                <div class="glassmorphism p-6 rounded-2xl shadow-md">
                    ...
                    <div class="flex space-x-4">
                        <a href="{{ $setting->site_fb }}"
                            class="w-10 h-10 rounded-full bg-primary-100 flex items-center justify-center hover:bg-primary-200 transition-all duration-200">
