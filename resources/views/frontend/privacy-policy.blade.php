...
<main class="container mx-auto px-4 py-8">
    ...
    <section class="flex flex-col items-center justify-center text-center py-16">
        ...
        @php
            $titleWords = explode(' ', $page->title, 2);
        @endphp

        <h1 class="text-4xl md:text-6xl font-bold dark-text mb-6">
            {{ $titleWords[0] }}
            @if (isset($titleWords[1]))
                <span class="accent-gradient-text">{{ $titleWords[1] }}</span>
            @endif
        </h1>
        ...
        <div class="max-w-4xl mx-auto">
            <div class="glassmorphism p-8 rounded-2xl shadow-md space-y-8">
                ...
                <div class="bg-primary-50 p-6 rounded-lg border border-primary-200">
                    ...
                    <p class="light-text mb-4">If you have questions about this privacy policy or how we handle your
                        data, please contact us:</p>
                    <div class="flex flex-col sm:flex-row gap-4">
                        <a href="/contact-us"
                            class="bg-primary-500 text-white px-6 py-2 rounded-lg font-semibold hover:bg-primary-600 transition-all duration-300 text-center">
                            <i class="fas fa-envelope mr-2"></i>Contact Us
                        </a>
                        <a href="mailto:{{ $setting->site_email }}"
                            class="bg-white text-primary-600 px-6 py-2 rounded-lg font-semibold border border-primary-300 hover:bg-primary-50 transition-all duration-300 text-center">
